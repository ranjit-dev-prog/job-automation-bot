...
INSERT INTO "new_JobFilter" ("createdAt", "customRulesJson", "delaySeconds", "id", "isActive", "keywords", "location", "maxApplicationsPerDay", "minSalary", "name", "platforms", "remoteOnly", "updatedAt", "userId") SELECT "createdAt", "customRulesJson", "delaySeconds", "id", "isActive", "keywords", "location", "maxApplicationsPerDay", "minSalary", "name", "platforms", "remoteOnly", "updatedAt", "userId" FROM "JobFilter";
