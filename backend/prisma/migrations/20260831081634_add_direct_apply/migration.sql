...
INSERT INTO "new_JobFilter" ("createdAt", "customRulesJson", "delaySeconds", "easyApplyOnly", "id", "isActive", "keywords", "location", "maxApplicationsPerDay", "minMatchScore", "minSalary", "name", "platforms", "remoteOnly", "updatedAt", "userId") SELECT "createdAt", "customRulesJson", "delaySeconds", "easyApplyOnly", "id", "isActive", "keywords", "location", "maxApplicationsPerDay", "minMatchScore", "minSalary", "name", "platforms", "remoteOnly", "updatedAt", "userId" FROM "JobFilter";
