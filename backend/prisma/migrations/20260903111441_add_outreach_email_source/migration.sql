...
INSERT INTO "new_OutreachEmail" ("applicationId", "attachResume", "body", "ccEmails", "company", "createdAt", "errorMessage", "id", "sentAt", "status", "subject", "targetCompanyId", "toEmail", "userId") SELECT "applicationId", "attachResume", "body", "ccEmails", "company", "createdAt", "errorMessage", "id", "sentAt", "status", "subject", "targetCompanyId", "toEmail", "userId" FROM "OutreachEmail";
